        ...
        <div class="card-body">
            <form action="{{ route('citas.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="trabajadora_id" id="trabajadora_id" class="form-control select2 @error('trabajadora_id') is-invalid @enderror" required>
                                ...
                                @foreach($trabajadoras as $trabajadora)
                                    <option value="{{ $trabajadora->id }}" {{ old('trabajadora_id') == $trabajadora->id ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <select name="servicios[]" id="servicios" class="form-control select2 @error('servicios') is-invalid @enderror" multiple required>
                        @foreach($servicios as $servicio)
                            <option value="{{ $servicio->id }}" {{ in_array($servicio->id, old('servicios', [])) ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <textarea name="observaciones" id="observaciones" rows="3" class="form-control @error('observaciones') is-invalid @enderror" placeholder="Ej: Cliente prefiere tinte sin amoniaco, alergia a ciertos productos, etc.">{{ old('observaciones') }}</textarea>
                    @error('observaciones')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
