...
@section('content')
<div class="row mb-2">
    <div class="col-sm-6"><h3>Editar Ingrediente</h3></div>
...
<div class="card">
    <div class="card-body">
        ...
        @endif
        <form method="POST" action="{{ route('ingredientes.update', $ingrediente) }}">
            @csrf @method('PUT')
            <div class="form-group">
                <label>Nombre <span class="text-danger">*</span></label>
                <input type="text" name="nombre" class="form-control" value="{{ old('nombre', $ingrediente->nombre) }}">
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Unidad de medida <small class="text-muted">(opcional)</small></label>
                        <input type="text" name="unidad_default" class="form-control" value="{{ old('unidad_default', $ingrediente->unidad_default) }}" placeholder="ej: taza, gramo, cdita, unidad...">
            ...
            <div class="form-group">
                ...
                <textarea name="descripcion" class="form-control" rows="2" placeholder="Notas sobre el ingrediente...">{{ old('descripcion', $ingrediente->descripcion) }}</textarea>
            </div>
            <div class="form-group">
                <div class="custom-control custom-switch">
                    <input type="hidden" name="es_alergeno" value="0">
                    <input type="checkbox" class="custom-control-input" id="esAlergeno" name="es_alergeno" value="1" {{ old('es_alergeno', $ingrediente->es_alergeno) ? 'checked' : '' }}>
