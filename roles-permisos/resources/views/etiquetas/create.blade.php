...
@section('content')
<div class="row mb-2">
    <div class="col-sm-6"><h3>Nueva Etiqueta</h3></div>
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('etiquetas.store') }}">
            ...
            <div class="form-group">
                <label>Nombre</label>
                <input type="text" name="nombre" class="form-control" value="{{ old('nombre') }}" placeholder="ej: Almuerzo, Postre, Sopa...">
            </div>
            <div class="form-group">
                ...
                <div class="input-group" style="max-width:220px">
                    <div class="input-group-prepend">
                        <span class="input-group-text p-1">
                            <input type="color" id="colorPicker" value="#3498db" style="width:32px;height:32px;border:none;cursor:pointer;padding:0">
                        </span>
                    </div>
                    <input type="text" name="color" id="colorHex" class="form-control" value="{{ old('color', '#3498db') }}" placeholder="#3498db" maxlength="7">
                </div>
