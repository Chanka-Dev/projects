<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Teléfono/WhatsApp -->
        <div class="mt-4">
            <x-input-label for="telefono" :value="__('WhatsApp / Teléfono')" />
            <x-text-input id="telefono" class="block mt-1 w-full" type="tel" name="telefono" :value="old('telefono')" required autocomplete="tel" placeholder="Ej: +58 412 1234567" />
